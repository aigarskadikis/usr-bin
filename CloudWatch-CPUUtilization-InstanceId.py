...
request_parameters = '{"StartTime":'+time_from+',"EndTime":'+time_till+',"MetricDataQueries":[{"Id":"m1","MetricStat":{"Metric":{"MetricName":"CPUUtilization","Namespace":"AWS/EC2","Dimensions":[{"Name":"InstanceId","Value":"'+sys.argv[1]+'"}]},"Period":300,"Stat":"Average"}}]}'
